      ...
      <div class="bg-black items-center gap-12 container flex flex-wrap justify-center mx-auto">
        <div>
          <div class="inline-flex items-center gap-2 w-20 h-20">
            ...
            <h2 class="text-white font-semibold">VueJs</h2>
          </div>
        </div>
        <div>
          <div class="inline-flex items-center gap-2 w-20 h-20">
            ...
            <h2 class="text-white font-semibold">Vuetify</h2>
          </div>
        </div>
        <div>
          <div class="inline-flex items-center gap-2 w-20 h-20">
            ...
            <h2 class="text-white font-semibold">Git</h2>
          </div>
        </div>
        ...
        <div>
          <div class="inline-flex items-center gap-2 w-20 h-20">
            ...
            <h2 class="text-white font-semibold">React</h2>
          </div>
        </div>
        <div>
          <div class="inline-flex items-center gap-2 w-20 h-20">
            ...
            <h2 class="text-white font-semibold">Vite</h2>
          </div>
        </div>
        ...
        <div>
          <div class="inline-flex items-center gap-2 w-20 h-20">
            ...
            <h2 class="text-white font-semibold">Nuxt.js</h2>
          </div>
        </div>
        <div>
          <div
        ...
        <div>
          <div class="inline-flex items-center gap-2 w-20 h-20">
            ...
            <h2 class="text-white font-semibold">Dart</h2>
          </div>
        </div>
        <div>
          <div class="inline-flex items-center gap-2 w-20 h-20">
            ...
            <h2 class="text-white font-semibold">Firebase</h2>
          </div>
        </div>
        <div>
          <div class="inline-flex items-center gap-2 w-20 h-20">
            ...
            <h2 class="text-white font-semibold">Kotlin</h2>
          </div>
        </div>
        ...
        <div>
          <div class="inline-flex items-center gap-2 w-20 h-20">
            ...
            <h2 class="text-white font-semibold">PHP</h2>
          </div>
        </div>
        <div>
          <div
        ...
        <div>
          <div class="inline-flex items-center gap-2 w-20 h-20">
            ...
            <h2 class="text-white font-semibold">Node.js</h2>
          </div>
        </div>
      </div>
    </div>
