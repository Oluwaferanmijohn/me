<template>
    <section class="border-b border-dotted border-neutral-600 bg-black overflow-hidden px-3">
        <div class="mx-auto max-w-[1340px] px-4 py-10 sm:px-6 sm:py-24 lg:me-0 lg:pe-0 lg:ps-8">
            <div class="grid grid-cols-1 gap-y-8 lg:grid-cols-3 lg:items-center lg:gap-x-16">
                <div class="max-w-xl text-center ltr:sm:text-left rtl:sm:text-right">
                    ...
                    <div class="hidden lg:mt-8 lg:flex lg:gap-4 justify-center">
                        ...
                        <button class="next-button rounded-full border border-neutral-600 p-3 text-neutral-600 hover:bg-neutral-600 hover:text-white">
            ...
            <div class="mt-8 flex justify-center gap-4 lg:hidden">
                <button aria-label="Previous slide" class="prev-button rounded-full border border-neutral-600 p-4 text-neutral-600 hover:bg-neutral-600 hover:text-white">
                    <svg class="h-5 w-5 -rotate-180 transform" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                        <path d="M9 5l7 7-7 7" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" />
                    </svg>
                </button>

                <button aria-label="Next slide" class="next-button rounded-full border border-neutral-600 p-4 text-neutral-600 hover:bg-neutral-600 hover:text-white">
