                    ...
                    <form class="mt-12">
                        <div class="-mx-2 md:items-center md:flex">
                            <div class="flex-1 px-2">
                                <label class="block mb-2 text-sm text-neutral-200">Full Name</label>
                                <input
                                    type="text"
                            ...
                            <div class="flex-1 px-2 mt-4 md:mt-0">
                                <label class="block mb-2 text-sm text-neutral-200">Email address</label>
                                <input
                                    type="email"
                ...
                <div class="mt-12 lg:flex lg:mt-0 lg:flex-col lg:items-center lg:w-1/2 lg:mx-10">
                    ...
                    <div class="mt-6 space-y-8 md:mt-8">
                        ...
                        <p class="flex items-start -mx-2">
                            ...
                            <span class="mx-2 truncate w-72 text-neutral-600">(234) 816-9066-040 </span>
                        </p>
                        ...
                        <p class="flex items-start -mx-2">
                            ...
                            <span class="mx-2 truncate w-72 text-neutral-600">Oluwatoyinferanmijohn@gmail.com</span>
                        </p>
                    </div>

                    <div class="mt-6 w-80 md:mt-8">
                        <h3 class="text-neutral-300">Follow us</h3>

                        <div class="flex mt-4 -mx-1.5">
                            <a class="mx-1.5 hover:text-blue-400 text-neutral-600 transition-colors duration-300 transform hover:" href="#">
